...
<p style="font-size:.75rem;color:#aaa;text-align:center;">Generated by AI Insights — ${new Date().toLocaleString('en-IN')}</p>
</body>
</html>`;
...
(function () {
    ...
    function createPanel() {
        ...
        panelEl.innerHTML =
            '<div class="aip-header">' +
                '<div class="aip-title"><i class="ph ph-sparkle" style="color:#a78bfa;"></i> AI Insights</div>' +
    ...
    function exportReport() {
        ...
        const html = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Report — ' + (p ? p.name : 'Project') + '</title>' +
            ...
            body.innerHTML +
            '<hr style="margin-top:2rem;border:none;border-top:1px solid #eee;">' +
            '<p style="font-size:.72rem;color:#aaa;text-align:center;">Generated by AI Insights — ' + new Date().toLocaleString('en-IN') + '</p>' +
            '</body></html>';
